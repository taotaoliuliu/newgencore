...
<br>
	...
	<form id="saveuser" class="form-horizontal" role="form" action="<%=basePath%>cms/save.do" method="post" onsubmit="return check()">
	 ...
	 <input name="content" id="content" type="hidden" /> 
		...
		<div class="form-group">
			...
			<div class="col-sm-3" style="height: 35px;">
			  ...
			  <sys:treeselect id="category" name="cid" value="" labelName="category.name" labelValue=""
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<textarea rows="4" name="digest" maxlength="200" class="input-xxlarge"></textarea>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<script id="editor" type="text/plain" style="width:100%;height:300px;">${bodyhtml }</script>
