...
<br>
	...
	<form id="saveuser" class="form-horizontal" role="form" action="${ctx }/cms/save.do" method="post" onsubmit="return check()">
		<input type="hidden" name="id" value="${role.id }">
		  
		  
		  		 <input name="bodyhtml" id="bodyhtml" type="hidden" /> 
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<textarea name="digest" rows="4" maxlength="200" class="input-xxlarge"></textarea>
			</div>
		</div>
		<div class="form-group">
