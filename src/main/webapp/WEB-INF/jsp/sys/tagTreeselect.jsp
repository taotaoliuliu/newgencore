...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$.get("${url}?extId=${extId}&isAll=${isAll}&module=${module}&t="
...
<body>
	...
	<div id="search" class="form-search" style="padding:10px 0 0 13px;">
		...
		<input type="text" class="empty" id="key" name="key" maxlength="50" style="width:110px;border-radius:5px;height: 30px;">
