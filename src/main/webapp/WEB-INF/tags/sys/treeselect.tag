...
<%@ attribute name="base" type="java.lang.String"
	required="false" description="基础路径"%>
 <div class="input-group">
 
 <input type="hidden" id="categoryid" name="categoryid" value="${article.category.id }">
<input readonly="readonly" type="text" id="categoryname" class="form-control" name="categoryname"
					placeholder="" value="${article.category.name }" style="width: 284px;background-color: #eeeeee">
	 				<span id="sercher" class="input-group-addon" style="cursor: pointer;" ><i class="glyphicon glyphicon-circle-arrow-down"></i>&nbsp;</span>
</div>
<script type="text/javascript">
	...
	$("#categoryname").click(function(){
		...
		// 正常打开	
		top.$.jBox.open("iframe:${base}/tag/treeselect.do?url="+encodeURIComponent("${base }/category/treeData.do")+"&module=${module}&checked=${checked}&extId=${extId}&isAll=${isAll}", "选择${title}", 300, 420, {
